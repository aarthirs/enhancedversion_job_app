...
class Jobs extends Component {
  ...
  getJobs = async () => {
    ...
    const apiUrl = `https://apis.ccbp.in/jobs?employment_type=${employeeType.join()}&minimum_package=${minimumSalary}&locaions=${locationList.join()}&search=${searchInput}`
  ...
  changeLocation = type => {
    this.setState(
      prev => ({locationList: [...prev.locationList, type]}),
      this.getJobs,
    )
  }
